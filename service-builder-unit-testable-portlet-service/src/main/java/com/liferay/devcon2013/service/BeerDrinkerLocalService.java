...
/**
 * Provides the local service interface for BeerDrinker. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see BeerDrinkerLocalServiceUtil
...
public interface BeerDrinkerLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link BeerDrinkerLocalServiceUtil} to access the beer drinker local service. Add custom service methods to {@link com.liferay.devcon2013.service.impl.BeerDrinkerLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
